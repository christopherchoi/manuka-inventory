...
insert into locations (name) values
  ('Australia'), ('Warehouse'), ('Chris Home'), ('Jang Home'), ('Customer'), ('Service')
...
from (values
 ...
 ('MGO300','transfer',8,'carton',48,'Chris Home','Jang Home',null,null,'Moved stock to Jang Home'),
 ('MGO100','transfer',6,'carton',36,'Chris Home','Jang Home',null,null,'Moved stock to Jang Home')
